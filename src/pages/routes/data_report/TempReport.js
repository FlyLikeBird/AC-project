        ...
        columns = [
            ...
            ...sourceData.date.map((date, index)=>{
                ...
                return {
                    ...
                    ellipsis:true,
                    render:(arr)=>{
                        return arr[index] === null ? '--': (+arr[index]).toFixed(1) + ' ℃';
                    }
                }
            })
        ];
...
export default connect(({ user, dataReport })=>({ user, dataReport }))(TempReport);